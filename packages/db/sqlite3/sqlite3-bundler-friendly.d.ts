/**
 * Type declarations for sqlite3-bundler-friendly.mjs
 */

declare module "../../packages/db/sqlite3/sqlite3-bundler-friendly.mjs" {
  ...
  function sqlite3InitModule(options?: InitOptions): Promise<SQLite3Module>;
